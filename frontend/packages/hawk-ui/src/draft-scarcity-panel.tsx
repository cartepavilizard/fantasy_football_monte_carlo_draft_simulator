...
import { PositionScarcity, PlayerTag, ScarcityCall, ScarcityReport } from "./types";
...
// under the draft board using the hawk-cards shell. Same per-position
// reach/wait badge + expandable at-risk list, hosted in a HawkCard.
//
// This is the presentational half. The connected half (the live
// useLazyGetScarcityQuery hook and its fetch trigger) lives in
// frontend/components/draft-scarcity-panel.tsx.
...
export interface ScarcityPanelProps {
  ...
  playerTagByName: Record<string, PlayerTag | null | undefined>;
  scarcityReport: ScarcityReport | undefined;
  scarcityFetching: boolean;
