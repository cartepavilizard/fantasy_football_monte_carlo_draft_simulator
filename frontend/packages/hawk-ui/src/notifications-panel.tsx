...
// This is the presentational half of the notifications bell/dropdown — all
// open/close, kind-filter, and click-outside UI state lives here since it
// needs no live data. The connected half (the useGetNotificationsQuery
// polling hook and the mark-read/mark-all-read/delete mutations) lives in
// frontend/components/notifications-panel.tsx, which supplies `notifications`
// and the action callbacks and calls `onOpen` to refetch on open.
...
export interface NotificationsPanelProps {
  ...
  onMarkAllRead: () => void;
  onDelete: (id: string) => void;
  // Called whenever the dropdown opens — the connected wrapper refetches.
  onOpen?: () => void;
}
