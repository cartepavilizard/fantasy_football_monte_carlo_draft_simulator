...
import { EmptyStateHawk } from "./mascots";
import { HawkChip } from "./hawk-cards";
// LeagueTeamInfo and TradeWillingnessLabel are not yet re-exported by the
// package's read-only ./types barrel (frontend/packages/hawk-ui/src/types.ts),
// which is a DONE foundation file outside this task's 10-file boundary. Rather
// than leave an app-alias types import (app-coupled) or duplicate the type
// defs, we import these two directly from the app's types barrel via the
// SAME relative path ./types itself uses internally ("../../../types") —
// keeping the package free of app-alias imports while still sourcing the
